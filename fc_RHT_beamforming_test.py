...
def prep_beam(files,matfile,nhours=1,fmax=10.,threshold_std=0.5,onebit=False,
    ...
    if new:
        ...
        for i,_f in enumerate(files):
            ...
            stalatlon_file='/Users/home/civilfra/Dropbox/codes/SA_USGS/SA_RHT_beamforming/RHT_stalocs.txt'
...
#            tr.filter("bandpass",freqmin=0.02,freqmax=0.4,corners=4,zerophase=True)
        ...
        #---------------------------
        # Setup latitude/longitude bounding box for the study area (for some reason)
        LonLref= 33.0
        LonUref= 55.0
        LatLref= 15.0
        LatUref= 32.0
...
#-----------------------------------
textfilename = '/Users/home/civilfra/Dropbox/codes/SA_USGS/SA_RHT_beamforming/RHT_001.txt'
datafiles = []
...
datdir = '/Volumes/GeoPhysics_14/users-data/civilfra/USGS_SA/SA_RHT_2014_001/'
outputdir = '/Volumes/GeoPhysics_14/users-data/civilfra/USGS_SA/SA_RHT_beamforming_output/'
main(datdir,datafiles,outputdir,nbeam=True,nprep=True,doplot=True,save=True,nostat=14)